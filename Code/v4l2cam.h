...
//*******************************
    ...
    int yuv2bgr(unsigned char *yuv, unsigned char *rgb, unsigned int width, unsigned int height);
    int convert_yuv_to_bgr_pixel(int y, int u, int v);
    QImage pixmap;
//*******************************
